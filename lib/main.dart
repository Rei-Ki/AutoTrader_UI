...
TODO как помечать активными

TODO как подхватывать с сервера активные
например можно в тегах указывать, что они активные и на каком таймфрейме,
но это надо таймфреймы отмечать работающие

TODO сделать завершение инструмента

TODO Можно сделать под графиком список запущенных инструментов с их таймфреймами
*/
